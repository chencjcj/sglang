...
class Envs:
    ...
    # done. Off by default: it buys the KV pool back ~6.5GB of headroom, but
    # unregistering scales with the NIC count the same way registering does.
    SGLANG_ENABLE_REMOTE_INSTANCE_MR_RELEASE = EnvBool(False)
